...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Privacy Policy | Pulse · Rotaract South Asia MDIO",
    description:
      "Privacy Policy for Pulse, operated by Rotaract South Asia MDIO (RSAMDIO).",
    url: "/privacy",
  },
  ...
  return (
    <LegalPage title="Privacy Policy" updated="23 July 2026">
      ...
      <p>
        ...
        and improve reliability. Organizers may export questions from rooms they
        manage.
      </p>
      ...
      <p>
        ...
        functions for Pulse. RSAMDIO does not sell your personal information.
      </p>
      ...
      <h2>Your choices</h2>
      <p>
        You can sign out at any time. To request deletion of your account data,
